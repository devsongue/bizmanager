...
export const Suppliers: React.FC<SuppliersProps> = ({ business, onAddSupplier }) => {
   ...
   <div className="flex items-center space-x-4 p-6">
        ...
        <div className="space-y-2">
          <p className="font-semibold text-gray-800 dark:text-gray-200">Fournisseurs</p>
          <p className="text-sm text-gray-600 dark:text-gray-400 animate-pulse">Chargement en cours...</p>
        </div>
      </div>
    </div>
        );
                ...
                <div className="flex items-center space-x-4">
                    <div className="relative">
                        <input
                            ...
                            className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"
                        />
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                        />
                    </div>
                    <div>
